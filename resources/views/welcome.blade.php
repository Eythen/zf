...
<head>
    ...
    <!-- Shop icon -->
    <link rel="shortcut icon" type="image/png" href="https://img.shoplineapp.com/media/image_clips/5f9b6e0a64cce622e5a9d1c5/original.png?1604021770">
                ...
                <li class="navigation-menu nav-color">
                    <ul class="navigation-menu-top-layer">
                        ...
                        <li class="navigation-menu-item navigation-menu-item--nested">
                            <a class="navigation-menu-item-label" href="http://shaji.twhealth.top/health.html" target="">沙棘保健品<span class="fa fa-angle-down"></span></a>
                        </li>
                        <li class="navigation-menu-item navigation-menu-item--nested">
                            <a class="navigation-menu-item-label" href="http://shaji.twhealth.top/beautiful.html" target=""> 沙棘保養品<span class="fa fa-angle-down"></span> </a>
                        </li>
                        <li class="navigation-menu-item navigation-menu-item--nested">
                            <a class="navigation-menu-item-label" href="http://shaji.twhealth.top/know-seabuckthorn.html" target=""> 認識沙棘<span class="fa fa-angle-down"></span> </a>
                        </li>
                    ...
                    <div id="page-item-5ffd4722cbe4060035c57a63" class="Grid-item Grid-text-item">
                        ...
                        <div class="Grid-item-content">
                            <table style="width: 100%;line-height: 8em;" id="jsjiesh">
                                ...
                                <tr>
                                    <td><span class="leftti">收貨人</span></td>
                                    <td><span class="rithtti"><input type="text"
                                                                     ...
                                                                     placeholder="請輸入收貨人姓名"></span></td>
                                </tr>
                                <tr>
                                    <td><span class="leftti">電話</span></td>
                                    <td><span class="rithtti"><input type="text"
                                                                     style="width: 500px;height: 40px;border:1px solid #ccc;border-radius: 10px;padding-left: 10px;font-size: 18px;"
                                                                     placeholder="請輸入收貨人電話"></span></td>
                                </tr>
                                <tr>
                                    <td><span class="leftti">收貨地址</span></td>
                                    <td><span class="rithtti"><input type="text"
                                                                     style="width: 500px;height: 40px;border:1px solid #ccc;border-radius: 10px;padding-left: 10px;font-size: 18px;"
                                ...
                                <tr>
                                    <td><span class="leftti">卡號</span></td>
                                    <td><span class="rithtti"><input type="text"
                                                                     style="width: 500px;height: 40px;border:1px solid #ccc;border-radius: 10px;padding-left: 10px;font-size: 18px;"
